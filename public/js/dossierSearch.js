$(document).ready(function () {
                    ...
                    <div data-dossier-id="${dossier.id }"
                        ...
                        if (Array.isArray(dossier.dossier_parties)) {
                           ...
                           <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <figure>
                                        <img class="rounded-lg" src="/path/to/public/${dossierPartie.damage_image}"
                                        alt="Damage Image">
                                    </figure>
                                </div>
                                        ...
                                        <g id="layer2" transform="matrix(0, 1, -1, 0, 254.000085527972, -254.000194186645)"
                                            ...
                                            <g id="g4428" transform="translate(-13.78 15.524)">
                                                <path class="mapPath"
                                                    ...
                                                    style="stroke: rgb(0, 0, 0); stroke-width: 5; fill: ${color7}
                                                ...
                                                <path class="mapPath"
                                                    ...
                                                    style="stroke: rgb(0, 0, 0); stroke-width: 5; fill: ${color13}
                                            ...
                                            <path class="mapPath"
                                                ...
                                                data-id-name="4" data-name="Feu avant gauche" data-id="path4361"
                                                    style="stroke: rgb(0, 0, 0); stroke-width: 5; fill: ${color4}
                                            ...
                                            <path class="mapPath"
                                                ...
                                                data-id-name="3" data-name="Feu avant droit" data-id="path4363"
                                                    style="stroke: rgb(0, 0, 0); stroke-width: 5; fill: ${color3}
                                            ...
                                            <path class="mapPath"
                                                ...
                                                data-id-name="1" data-name="Plaque immatriculation avant" data-id="path28"
                                                    style="stroke: rgb(0, 0, 0); stroke-width: 5; fill: ${color1}
                                            ...
                                            <path class="mapPath"
                                                ...
                                                data-id-name="20" data-name="Plaque immatriculation arriere" data-id="path37"
                                                    style="stroke: rgb(0, 0, 0); stroke-width: 5; fill: ${color20}
 ...
 `;
                                console.log(dossierPartie); // Example
                            });
                        } else {
