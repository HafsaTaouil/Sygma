<x-app-layout>
    ...
    <div class="ml-auto md:w-[90%] pt-8">
        ...
        <div class="container text-center flex items-center mx-auto">
            <div
                ...
                <div class="p-5 ">
                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Créer votre rapport via l'option qui
                        vous convient</p>
                    <div class="report-creation-options-container">
                        <a href="#" id="report-creation-manually"
                        ...
                        <a href="#" id="report-creation-via-vrd"
                            class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                ...
                <button type="button" id="retry-btn"
                    class="text-white bg-purple-700 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">Réssayer</button>
        ...
        <div class=" md:w-[90%] ml-auto pt-8">
            <form id="submit_all" action="{{ route('dossier.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div id="report-creation-via-vrd1" class="mt-4 bg-white p-4 py-8 rounded-lg">
                    <div id="alert-additional-content-5" class="p-4 border border-gray-300 rounded-lg bg-gray-50"
                        role="alert">
                        ...
                        <div class="flex flex-row md:flex-no-wrap flex-wrap-reverse md:flex-row justify-between">
                            <div id="uls-container" class="mt-2 mb-4 text-sm text-gray-800">
                                <ul class="mt-1.5 ml-8 list-disc list-inside space-y-2">
                                    <li class="font-bold" id="numero">Numéro d'immatriculation: <input type="text"
                                            name="data[Machine][num_imma]"
                                            class="border rounded-lg border-black p-1 font-normal"></li>
                                    <li class="font-bold" id="immat">Immatriculation antérieure: <input
                                            type="text" name="data[Machine][num_imma_ante]"
                                            class="border rounded-lg border-black p-1 font-normal"></li>
                                    <li class="font-bold" id="premiere">Première mise en circulation: <input
                                            type="text" name="data[Machine][date_mc]"
                                            class="border rounded-lg border-black p-1 font-normal"></li>
                                    <li class="font-bold" id="mc">M.C. au Maroc: <input type="text"
                                            name="data[Machine][date_mc_maroc]"
                                            class="border rounded-lg border-black p-1 font-normal"></li>
                                    <li class="font-bold" id="usage">Usage: <input type="text"
                                            name="data[Machine][v_usage]"
                                            class="border rounded-lg border-black p-1 font-normal"></li>
                                    <li class="font-bold" id="proper">Propriétaire: <input type="text"
                                            name="data[Machine][name]"
                                            class="border rounded-lg border-black p-1 font-normal"></li>
                                    <li class="font-bold" id="address">Adresse: <input type="text"
                                            name="data[Machine][adresse]"
                                            class="border rounded-lg border-black p-1 font-normal"></li>
                                    <li class="font-bold" id="fin">Fin de validité: <input type="text"
                                            name="data[Machine][fin_valide]"
                                            class="border rounded-lg border-black p-1 font-normal"></li>
                                </ul>
                                <ul class="mt-8 ml-8 list-disc list-inside space-y-2">
                                    <li class="font-bold" id="marque">Marque: <input type="text"
                                            name="data[Machine][marque]"
                                            class="border rounded-lg border-black p-1 font-normal"></li>
                                    <li class="font-bold" id="type">Type: <input type="text"
                                            name="data[Machine][type]"
                                            class="border rounded-lg border-black p-1 font-normal"></li>
                                    <li class="font-bold" id="genre">Genre: <input type="text"
                                            name="data[Machine][genre]"
                                            class="border rounded-lg border-black p-1 font-normal"></li>
                                ...
                                <input type="hidden" id="selectedModele" name="data[Machine][modele]">
                                    ...
                                    <li class="font-bold" id="modele">Modèle: <input type="text"
                                            name="data[Machine][modele]"
                                            class="border rounded-lg border-black p-1 font-normal"></li>
                                    <li class="font-bold" id="carburant">Type carburant: <input type="text"
                                            name="data[Machine][type_carburant]"
                                            class="border rounded-lg border-black p-1 font-normal"></li>
                                    <li class="font-bold" id="chassis">N° de châssis: <input type="text"
                                            name="data[Machine][n_chassis]"
                                            class="border rounded-lg border-black p-1 font-normal"></li>
                                    <li class="font-bold" id="cylindre">Nombre de cylindres: <input type="text"
                                            name="data[Machine][n_cylindres]"
                                            class="border rounded-lg border-black p-1 font-normal"></li>
                                    <li class="font-bold" id="fiscale">Puissance fiscale: <input type="text"
                                            name="data[Machine][puissance]"
                                            class="border rounded-lg border-black p-1 font-normal"></li>
                                </ul>
                            </div>
                            <div id="recto-verso" class="flex flex-col gap-4 items-center">
                                <div id="image-flip" class="flex flex-row gap-4 items-center">
                                    <div class="flex flex-col">
                                        <label for="frontCard"
                                            class="cursor-pointer hover:bg-white transition-all flex flex-col justify-center items-center w-fit h-40 md:w-[302px] md:h-[204px] border-dashed border-2 rounded-lg bg-gray-200 border-gray-300">
                                            <i class="text-gray-400 text-3xl fas fa-upload"></i>
                                            <p class="text-center text-gray-400">Cliquez ici pour importer le recto de
                                                votre carte grise</p>
                                            <input id="frontCard" type="file" class="hidden"
                                                name="data[Machine][cartrecto]" />
                                        </label>
                                    </div>
                                    <div class="flex flex-col">
                                        <label for="backCard"
                                            class="cursor-pointer hover:bg-white flex flex-col justify-center items-center w-fit h-40 md:w-[302px] md:h-[204px] border-dashed border-2 rounded-lg bg-gray-200 border-gray-300">
                                            <i class="text-gray-400 text-3xl fas fa-upload"></i>
                                            <p class="text-center text-gray-400">Cliquez ici pour importer le verso de
                                                votre carte grise</p>
                                            <input id="backCard" type="file" class="hidden"
                                                name="data[Machine][cartverso]" />
                                        </label>
                                    </div>
                                </div>
                                <button id="submitBtn"
                                    class="text-white bg-purple-700 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">Envoyer
                                    Photos</button>
                    ...
                    <div id="alert-additional-content-5" class="p-4 border border-gray-300 rounded-lg bg-gray-50"
                        ...
                        <div class="flex flex-row justify-between">
                            <div class="mt-2 mb-4 text-sm text-gray-800 h-fit">
                                Sélectionnez différentes parties de la voiture dans le schéma suivant, puis insérez une
                                photo de la partie endommagée (s'il y en a une) et sélectionnez la gravité des dommages.
                                Une fois que vous avez ajouté les informations relatives à la carte grise et aux
                                dommages subis par la voiture, cliquez sur le bouton « Soumettre ».
                                <div class="flex w-full justify-between">
                                    <div id="gridDiv" class="grid grid-cols-5 gap-4 h-fit mt-2">

                                    </div>
                                    <svg class="block w-1/3" viewBox="280 -280 1100 1800"
                                        xmlns="http://www.w3.org/2000/svg" id="car-map">
                                        <g id="layer2"
                                            transform="matrix(0, 1, -1, 0, 254.000085527972, -254.000194186645)"
                                            ...
                                            <g id="g4113" transform="translate(-13.78 3.524)">
                                                ...
                                                <path class="mapPath"
                                                    ...
                                                    data-id-name = "8" data-name="Aile avant gauche"
                                                    data-id="path30701"
                                                    style="stroke: rgb(0, 0, 0); stroke-width: 5; fill: rgb(255, 255, 255);"
                                                ...
                                                <path class="mapPath"
                                                    ...
                                                    data-id-name = "10" data-name="Porte avant gauche"
                                                    data-id="path3900"
                                                    style="stroke: rgb(0, 0, 0); stroke-width: 5; fill: rgb(255, 255, 255);"
                                                ...
                                                <path class="mapPath"
                                                    ...
                                                    data-id-name = "12" data-name="Porte arriere gauche"
                                                    data-id="path39006"
                                            ...
                                            <g id="g4451" transform="translate(-13.78 15.524)">
                                                ...
                                                <path class="mapPath"
                                                    ...
                                                    data-id-name = "6" data-name="Pare-brise avant"
                                                    data-id="path4165"
                                                    style="stroke: rgb(0, 0, 0); stroke-width: 5; fill: rgb(255, 255, 255);"
                                                ...
                                                <path class="mapPath"
                                                    ...
                                                    data-id-name = "15" data-name="Pare-brise arriere"
                                                    data-id="path4205"
                                                    style="stroke: rgb(0, 0, 0); stroke-width: 5; fill: rgb(255, 255, 255);"
                                            ...
                                            <g id="g4428" transform="translate(-13.78 15.524)">
                                                <path class="mapPath"
                                                    data-bg="https://www.piece-carrosserie-discount.com/image/pare-chocs-183428.jpg"
                                                    data-id-name = "7" data-name="Aile avant droit"
                                                    data-id="path38526"
                                                ...
                                                <path class="mapPath"
                                                    ...
                                                    data-id-name = "13" data-name="Aile arriere droit"
                                                    data-id="path385267"
                                                ...
                                                <path class="mapPath"
                                                    ...
                                                    data-id-name = "9" data-name="Porte avant droite"
                                                    data-id="path39004"
                                                ...
                                                <path class="mapPath"
                                                    data-bg="https://fs.opisto.fr/Pictures/4481/2023_1/Piece-Porte-avant-droit-801001895R-DACIA-LOGAN-1-PHASE-1-deab956cb50582ae623aece05c3df1d4929bb97179869cebfb401fe22e570376_mtn.jpg"
                                                    data-id-name = "11" data-name="Porte arriere droite"
                                                    data-id="path39422"
                                            ...
                                            <path class="mapPath"
                                                ...
                                                data-id-name = "1" data-name="Plaque immatriculation avant"
                                                data-id="path28"
                                                style="stroke-width: 5px; stroke: rgb(0, 0, 0); paint-order: stroke; fill: rgb(255, 255, 255);"
                                            ...
                                            <path class="mapPath"
                                                ...
                                                data-id-name = "20" data-name="Plaque immatriculation arriere"
                                                data-id="path37"
                                                style="stroke-width: 5px; stroke: rgb(0, 0, 0); paint-order: stroke; fill: rgb(255, 255, 255);"
        ...
        <div id="added_data">
            ...
            <button form="submit_all" type="submit" class="mt-4 p-2 bg-blue-500 text-white rounded md:mb-5 w-full">Ajouter
                Dossier</button>


        </div>

        <footer class="  bg-[#009999] h-[74px] flex flex-col justify-center px-4 py-5 ">
            <div class="sm:px-12 flex justify-center flex-col">
               
                <p class='text-center text-white text-base'>Copyright © {{ now()->year }}<a href='/' 
                        class="hover:underline mx-1 text-[#fff] underline  font-bold">SYGMA.AI</a>All Rights Reserved.</p>
            </div>
        </footer>
                ...
                document.querySelectorAll('.mapPath').forEach(mapPath => {
                    ...
                    document.getElementById(`submit_${dataIdName}`).addEventListener('click', () => {
                        const severity = document.querySelector(
                            `input[name="severity_${dataIdName}"]:checked`).value;
                        console.log("severity is : ", severity);

                        const severityNum = document.querySelector(
                            `input[name="severity_${dataIdName}"]:checked`).getAttribute(
                            'data-severity');
    ...
    <script>
        $(document).ready(function() {
            ...
            var htm1 =
                "<span class='content'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> <strong>!</strong>&nbsp;&nbsp;" +
                text1 + "</span>";
            $("#flashMessage").html('<i class="zmdi zmdi-check-circle"></i>');
            $("#flashMessage").html(htm1);
            $("#flashMessage").attr("class",
                "alert au-alert-success alert-dismissible fade show au-alert au-alert--70per m-b-25");
